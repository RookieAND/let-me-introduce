          ...
          <div className="flex flex-col gap-5.5 max-w-[68ch]">
            <Reveal>
              <Text variant="body1" color="muted">
                ...
                <br />
                코드가 답일 때도 있지만, 때로는{" "}
                <strong className="text-text font-semibold">사람들과 의견을 맞추는 게 </strong> 답일
                때도 있기 때문입니다.
              </Text>
            </Reveal>
            <Reveal delay={0.08}>
              <Text variant="body1" color="muted">
                ...
                <strong className="text-text font-semibold">Build Tooling</strong> 입니다. <br />
                그러면서도 폼 빌더·권한 관리처럼 사용자가 마주하는 화면 안쪽의 구조까지 직접
                설계합니다.
                <br />
                팀이 개발하는 환경과 사용자가 바라보는 화면을{" "}
                <strong className="text-text font-semibold">같은 손으로 다루는 것이</strong> 제
                강점입니다.
              </Text>
            </Reveal>
          </div>
