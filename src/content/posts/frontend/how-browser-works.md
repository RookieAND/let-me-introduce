...
프론트엔드 기술 면접의 단골 질문, 브라우저는 어떻게 서버에서부터 받은 리소스를 화면에 렌더링할까요? 이다.  
사실 지금까지 내가 봤던 기술 면접 중에서는 아직 이 질문을 받은 적이 없지만.. ~~(비교적 더 어려운 질문들이 많았다 젠장)~~ 그래도 내심 궁금한 건 사실이었다.  
대체 브라우저는 어떻게 이루어졌길래 이렇게 다양한 컨텐츠들을 문제없이 착착 보여줄 수 있는 걸까?  
