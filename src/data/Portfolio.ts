...
export const PRINCIPLES = [
  {
    num: "01",
    title: "문제를 먼저 올바르게 정의한다",
    lines: [
      "코드를 짜기 전, 어떻게 해결할지 정의한다.",
      "요구사항 이면의 맥락을 파악해 엣지 케이스와 상태 변화 흐름을 모델링하는 것이 좋은 개발의 시작이다.",
    ],
  },
  {
    num: "02",
    title: "팀과 개인의 성장을 함께 챙긴다",
    lines: [
      "내가 잘하는 것보다 팀이 더 잘할 수 있는 구조를 만드는 게 더 중요하다.",
      "리뷰·문서·자동화를 통해 개인의 지식이 팀 자산이 되도록 기여한다.",
    ],
  },
  {
    num: "03",
    title: "기술은 목적을 위한 수단이다",
    lines: [
      "유행을 좇기보다 문제에 맞는 기술을 선택하고, 그 선택의 이유를 명확히 설명할 수 있어야 한다.",
      "원리를 깊게 파고드는 습관이 그 판단의 근거가 된다.",
    ],
  },
] as const;
