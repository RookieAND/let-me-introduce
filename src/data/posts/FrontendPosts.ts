...
export const FRONTEND_POSTS: Post[] = [
  ...
  {
    slug: "react-use-sync-external-store-internals",
    date: "2024-06-10",
    cat: "Frontend",
    title: "useSyncExternalStore 내부를 들여다보다 — subscribe, getSnapshot, Shim 분석",
    excerpt: [
      "subscribe에 넘기는 listener가 실제로 무엇인지, getSnapshot과 getServerSnapshot의 차이, Shim 코드로 추적한 내부 실행 흐름 정리.",
    ],
    tags: ["React", "useSyncExternalStore", "React 18", "Shim"],
    read: "10 min",
    href: "/posts/react-use-sync-external-store-internals",
  },
  {
    slug: "react-use-sync-external-store",
    date: "2024-06-21",
    cat: "Frontend",
    title: "useSyncExternalStore로 복잡한 트리 상태 풀어내기",
    excerpt: [
      "3 Depth 학습맵 트리에 얽힌 Cascading·Guard·리포트 분기를 AchievementTree Class로 격리하고 useSyncExternalStore로 연결한 과정.",
    ],
    tags: ["React", "useSyncExternalStore", "외부 스토어", "상태 관리", "Class"],
    read: "12 min",
